...
<body>
	<div class="clock">
		<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" id="clockface" viewBox="0 0 960 960" style="enable-background:new 0 0 960 960;" xml:space="preserve">
	...
	<form name="clock" onSubmit="0">
		<input type="text" name="face" size=11 value ="<?= pantonish_time_now() ?>">
	</form>
